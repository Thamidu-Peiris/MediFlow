      ...
      <main className="pt-24 pb-20">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="space-y-12">
            <section className="rounded-2xl border border-[#356600]/10 bg-white p-8 shadow-sm">
              <h2 className="text-2xl font-bold text-[#043927] flex items-center gap-3">
                <span className="material-symbols-outlined text-[#437A00]">verified</span>
                Our Mission
              </h2>
              <p className="mt-4 leading-relaxed text-[#043927]/70">
            ...
            <section className="grid gap-8 md:grid-cols-2">
              <div className="rounded-2xl border border-[#356600]/10 bg-white p-8 shadow-sm transition-transform hover:-translate-y-1">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-[#CBF79D] text-[#043927]">
                  <span className="material-symbols-outlined">groups</span>
                </div>
                <h3 className="text-xl font-bold text-[#043927]">Expert Network</h3>
                <p className="mt-2 text-[#437A00]">
              ...
              <div className="rounded-2xl border border-[#356600]/10 bg-white p-8 shadow-sm transition-transform hover:-translate-y-1">
                ...
                <h3 className="text-xl font-bold text-[#043927]">Patient Privacy</h3>
                <p className="mt-2 text-[#437A00]">
            ...
            <section className="rounded-2xl bg-gradient-to-br from-[#437A00] to-[#043927] p-8 text-white shadow-lg text-center">
              <h2 className="text-3xl font-extrabold">Ready to start your journey?</h2>
              <p className="mt-4 text-[#CBF79D]">
                Join thousands of patients who trust MediFlow for their healthcare needs.
              </p>
              <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
                <Link to="/register" className="rounded-full bg-[#CBF79D] px-8 py-3 font-bold text-[#043927] transition-all hover:bg-[#b5f07a]">
                  Get Started
                </Link>
                <Link to="/doctors" className="rounded-full border-2 border-[#CBF79D]/50 px-8 py-3 font-bold text-white transition-all hover:bg-[#CBF79D]/20">
                  Browse Doctors
                </Link>
              </div>
            </section>

          ...
          <div className="profile-hero-content">
            <div className="profile-avatar-section">
              <div className="avatar-container-large">
                ...
                >
                  {/* Camera icon: reads clearly at small sizes; svg sized via CSS so flex does not shrink it */}
                  <svg className="avatar-edit-btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round" aria-hidden>

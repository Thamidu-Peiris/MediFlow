    ...
    <div className="min-h-screen bg-[#c0fc92] font-sans">
      ...
      <main className="pt-24 pb-20">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="rounded-2xl border border-[#356600]/10 bg-white p-8 shadow-sm space-y-8">
            <section>
              <h2 className="text-xl font-bold text-[#043927] mb-4">1. Information We Collect</h2>
              <p className="text-[#043927]/70 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#043927] mb-4">2. How We Use Information</h2>
              <p className="text-[#043927]/70 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#043927] mb-4">3. Data Security</h2>
              <p className="text-[#043927]/70 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#043927] mb-4">4. Compliance</h2>
              <p className="text-[#043927]/70 leading-relaxed">
            ...
            <div className="pt-8 border-t border-[#356600]/10">
              <p className="text-sm text-[#437A00]">

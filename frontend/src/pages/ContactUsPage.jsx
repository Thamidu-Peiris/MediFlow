...
export default function ContactUsPage() {
  return (
    <div className="min-h-screen bg-[#c0fc92] font-sans">
      <LandingTopBar active="contact" />
      
      <main className="pt-24 pb-20">
        <div className="mx-auto max-w-5xl px-6">
          <div className="mb-12 text-center">
            <span className="inline-block rounded-full bg-[#CBF79D] px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-[#043927] border border-[#356600]/10">
              Support
            </span>
            <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-[#043927] sm:text-5xl">
              Get in Touch
            </h1>
            <p className="mt-4 text-lg text-[#437A00]">
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            <div className="space-y-6">
              <div className="rounded-2xl border border-[#356600]/10 bg-white p-6 shadow-sm">
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-[#CBF79D] text-[#043927]">
                  <span className="material-symbols-outlined">mail</span>
                </div>
                <h3 className="text-lg font-bold text-[#043927]">Email Us</h3>
                <p className="mt-1 text-[#437A00]">support@mediflow.com</p>
                <p className="text-[#437A00]">billing@mediflow.com</p>
              </div>
              ...
              <div className="rounded-2xl border border-[#356600]/10 bg-white p-6 shadow-sm">
                ...
                <h3 className="text-lg font-bold text-[#043927]">Call Support</h3>
                <p className="mt-1 text-[#437A00] font-semibold">+1 (800) MEDI-FLOW</p>
                <p className="text-[#437A00]">Mon-Fri, 9am-6pm EST</p>
              </div>
              ...
              <div className="rounded-2xl border border-[#356600]/10 bg-white p-6 shadow-sm">
                ...
                <h3 className="text-lg font-bold text-[#043927]">Our Office</h3>
                <p className="mt-1 text-[#437A00]">123 Medical Plaza, Suite 500</p>
                <p className="text-[#437A00]">Silicon Valley, CA 94025</p>
              </div>
            </div>

            {/* Contact Form */}
            <div className="lg:col-span-2">
              <div className="rounded-2xl border border-[#356600]/10 bg-white p-8 shadow-sm">
                <form className="space-y-6">
                  <div className="grid gap-6 md:grid-cols-2">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-[#043927] uppercase tracking-wider">Full Name</label>
                      <input 
                        type="text" 
                        placeholder="John Doe"
                        className="w-full rounded-xl border border-[#356600]/10 px-4 py-3 text-[#043927] outline-none focus:border-[#356600] focus:ring-4 focus:ring-[#356600]/10 transition-all"
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-[#043927] uppercase tracking-wider">Email Address</label>
                      <input 
                        type="email" 
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-[#043927] uppercase tracking-wider">Subject</label>
                    <select className="w-full rounded-xl border border-[#356600]/10 px-4 py-3 text-[#043927] outline-none focus:border-[#356600] focus:ring-4 focus:ring-[#356600]/10 transition-all appearance-none bg-white">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-[#043927] uppercase tracking-wider">Message</label>
                    <textarea 
                      rows="5"
                  ...
                  <button 
                    type="submit"
                    className="w-full rounded-xl bg-gradient-to-br from-[#437A00] to-[#043927] py-4 font-bold text-white shadow-lg shadow-[#437A00]/20 transition-all hover:opacity-90 active:scale-[0.98]"
                  >
                    Send Message
                  </button>
                </form>
